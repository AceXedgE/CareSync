...
const SignUpScreen: React.FC = () => {
    ...
    const handleSignUp = () => {
        ...
        console.log({
            role, firstName, lastName, otherName, email, username, location, password, confirmPassword
        });
    };
        ...
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.card}>
                ...
                <View style={styles.toggleRow}>
                    ...
                    >
                        <Text style={[styles.toggleButtonText, role === 'Patient' && styles.toggleButtonTextActive]}>Patient</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={[styles.toggleButton, role === 'Provider' && styles.toggleButtonActive]}
                        onPress={() => setRole('Provider')}
                    >
                        <Text style={[styles.toggleButtonText, role === 'Provider' && styles.toggleButtonTextActive]}>Provider</Text>
                    </TouchableOpacity>
                </View>
